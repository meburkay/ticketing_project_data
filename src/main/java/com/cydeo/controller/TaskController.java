...
public class TaskController {
    ...
    public String employeeUpdateTask(@Valid @ModelAttribute("task") TaskDTO task, BindingResult bindingResult, Model model) {
        ...
        //At MVC part we use updateStatus method but we add a ternary operator to the update method and after that we do not need to use that method. update method can be used in every situation.
        taskService.update(task);
